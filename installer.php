...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Farid_Bou_9773f93dc6475a0e2770_20220329100109_archive.zip';
	const ARCHIVE_SIZE		 = '73305139';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '9773f93-29100109';
    const SECONDARY_PACKAGE_HASH = 'c1866e7-29100109';
	const VERSION			 = '1.4.4';
